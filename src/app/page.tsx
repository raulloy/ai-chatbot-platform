    ...
    <main>
      ...
      <section>
        <div className="flex items-center justify-center flex-col mt-[80px] gap-4 ">
          <span className="text-blue-900 bg-blue-50 px-4 py-2 rounded-full text-sm">
            AI Virtual Assistant Chatbot
          </span>
          <Image
            src="/images/ai-chatbot-assistant.png"
            width={500}
            height={100}
            alt="Logo"
          ...
          {/* <p className="text-center max-w-[500px]">
            Your AI powered assistant! Embed AI Assistant into any website with
